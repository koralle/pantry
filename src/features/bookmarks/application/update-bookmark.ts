 ...
 */
export type UpdateBookmarkCommand = v.InferOutput<
  typeof updateBookmarkInputSchema
>;

export interface UpdatedBookmark {
...
export const executeUpdateBookmark = async (params: {
