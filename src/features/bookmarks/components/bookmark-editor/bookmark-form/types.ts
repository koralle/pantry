 ...
 */
export interface BookmarkFormServerError {
 ...
 */
export interface BookmarkEditorError {
  readonly form?: BookmarkFormServerError;
}

export interface BookmarkFormInitialValues {
  readonly url: string;
...
export interface BookmarkTitleFetchPayload {
  readonly url: string;
}
