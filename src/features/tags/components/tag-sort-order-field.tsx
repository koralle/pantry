...
interface TagSortOrderFieldProps {
  readonly sortOrder: number;
  readonly onSortOrderChange: (sortOrder: number) => void;
  readonly disabled?: boolean;
}

export const TagSortOrderField = ({
  sortOrder,
  onSortOrderChange,
  disabled = false,
  ...
  >
    ...
    <Group className={sortOrderRow}>
      <StyledButton slot="decrement" aria-label="並び順を下げる">
      ...
      />
      <StyledButton slot="increment" aria-label="並び順を上げる">
