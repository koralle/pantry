...
export const toTagName = (input: string): TagName => {
...
export const uniqueNormalizedTagNames = (
...
export const tagNamesMatch = (left: string, right: string): boolean =>
  toTagName(left).normalized === toTagName(right).normalized;
