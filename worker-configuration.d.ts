/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.typegen` (hash: e3b79b2a6c9a69be332c356ea3de3e11)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'TURSO_CONNECTION_URL' | 'TURSO_AUTH_TOKEN' | 'BETTER_AUTH_SECRET' | 'BETTER_AUTH_URL'
    >
  > {}
}
